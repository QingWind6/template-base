...
namespace {
constexpr const char* kTag = "JugglerBoard";
}

class JugglerBoard : public Board {
public:
...
private:
    ...
    void InitializeSensors() {
        // Board-specific chip implementations belong in board/juggler/devices.
